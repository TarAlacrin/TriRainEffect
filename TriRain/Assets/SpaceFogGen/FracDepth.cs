...
[Serializable, VolumeComponentMenu("Post-processing/Custom/FracDepthShader")]
public sealed class FracDepth : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    ...
    const string kShaderName = "Hidden/Shader/FracDepthShader";
    ...
    public override void Setup()
    {
        if (Shader.Find(kShaderName) != null)
            ...
            Debug.LogError($"Unable to find shader '{kShaderName}'. Post Process Volume FracDepth is unable to load.");
    }
